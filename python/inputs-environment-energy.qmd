...
```{python}
use_sec_agg_pefa = pd.DataFrame(index=agg_ind.keys(), columns=E_products_PEFA)
for m in E_products_PEFA:
    for i in agg_ind.keys():
...
```{python}
t_use_sec_agg = pd.DataFrame(index=agg_ind.keys(), columns=E_products_PEFA)
for m in E_products_PEFA:
    for i in agg_ind.keys():
        t_use_sec_agg.loc[i, m] = t_use.loc[m, agg_ind[i]].sum()

f_use_sec_agg = pd.DataFrame(index=agg_ind.keys(), columns=E_products_PEFA)
for m in E_products_PEFA:
    for i in agg_ind.keys():
        f_use_sec_agg.loc[i, m] = f_use.loc[m, agg_ind[i]].sum()

e_use_sec_agg = pd.DataFrame(index=agg_ind.keys(), columns=E_products_PEFA)
for m in E_products_PEFA:
    for i in agg_ind.keys():
...
```{python}
f_use_share_D = pd.DataFrame(index=D_sectors, columns=E_products_PEFA)
for i in D_sectors:
...
```{python}
e_use_share_D = pd.DataFrame(index=D_sectors, columns=E_products_PEFA)
for i in D_sectors:
